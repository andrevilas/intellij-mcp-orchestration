...
- `pnpm --dir app exec vitest run src/pages/AdminChat/McpServersList.test.tsx` ✅【6a1f36†L1-L9】
...
- Vitest já inicializa `__CONSOLE_MCP_FIXTURES__ = 'ready'` via `app/src/setupTests.ts`, permitindo que os helpers Playwright/Vitest identifiquem o modo ativo.
